...
export class EmpleadoService {
  ...
  //   return this.clientService.get(this.API+"?borrarEmpleado="+id);
  // }
  ...
  // EditarEmpleado2(id:string): Observable<any> {
  //   return this.clientService.get(this.API+"?editarEmpleado="+id);
  // }
